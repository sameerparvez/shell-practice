...
SG_ID="sg-09910ba92aaf8a435" # replace with your SG ID
INSTANCES=("mongodb" "redis" "mysql" "rabbitmq" "catalogue" "user" "cart" "shipping" "payment" "dispatch")
ZONE_ID="Z0024432DFPWVB7GYVA9" # replace with your ZONE ID
DOMAIN_NAME="sameerdevops.space" # replace with your domain
